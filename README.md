...
[Backends, configuring and extending](https://github.com/artpar/go-guerrilla/wiki/Backends,-configuring-and-extending) page.
...
- Try hacking the source and [create your own processor](https://github.com/artpar/go-guerrilla/wiki/Backends,-configuring-and-extending).
- Once your daemon is running, you might want to stup [log rotation](https://github.com/artpar/go-guerrilla/wiki/Automatic-log-file-management-with-logrotate).
...
Please continue to the [API documentation](https://github.com/artpar/go-guerrilla/wiki/Using-as-a-package) for the following topics:


- [Suppressing log output](https://github.com/artpar/go-guerrilla/wiki/Using-as-a-package#starting-a-server---suppressing-log-output)
- [Custom listening interface](https://github.com/artpar/go-guerrilla/wiki/Using-as-a-package#starting-a-server---custom-listening-interface)
- [What else can be configured](https://github.com/artpar/go-guerrilla/wiki/Using-as-a-package#what-else-can-be-configured)
- [Backends](https://github.com/artpar/go-guerrilla/wiki/Using-as-a-package#backends)
    - [About the backend system](https://github.com/artpar/go-guerrilla/wiki/Using-as-a-package#about-the-backend-system)
    - [Backend Configuration](https://github.com/artpar/go-guerrilla/wiki/Using-as-a-package#backend-configuration)
    - [Registering a Processor](https://github.com/artpar/go-guerrilla/wiki/Using-as-a-package#registering-a-processor)
- [Loading config from JSON](https://github.com/artpar/go-guerrilla/wiki/Using-as-a-package#loading-config-from-json)
- [Config hot-reloading](https://github.com/artpar/go-guerrilla/wiki/Using-as-a-package#config-hot-reloading)
- [Logging](https://github.com/artpar/go-guerrilla/wiki/Using-as-a-package#logging-stuff)
- [Log re-opening](https://github.com/artpar/go-guerrilla/wiki/Using-as-a-package#log-re-opening)
- [Graceful shutdown](https://github.com/artpar/go-guerrilla/wiki/Using-as-a-package#graceful-shutdown)
- [Pub/Sub](https://github.com/artpar/go-guerrilla/wiki/Using-as-a-package#pubsub)
- [More Examples](https://github.com/artpar/go-guerrilla/wiki/Using-as-a-package#more-examples)
...
- [guerrillad command](https://github.com/artpar/go-guerrilla/wiki/Running-from-command-line#guerrillad-command)
    - [Starting](https://github.com/artpar/go-guerrilla/wiki/Running-from-command-line#starting)
    - [Re-loading configuration](https://github.com/artpar/go-guerrilla/wiki/Running-from-command-line#re-loading-the-config)
    - [Re-open logs](https://github.com/artpar/go-guerrilla/wiki/Running-from-command-line#re-open-log-file)
    - [Examples](https://github.com/artpar/go-guerrilla/wiki/Running-from-command-line#examples)

### Other topics

- [Using Nginx as a proxy](https://github.com/artpar/go-guerrilla/wiki/Using-Nginx-as-a-proxy)
- [Testing STARTTLS](https://github.com/artpar/go-guerrilla/wiki/Running-from-command-line#testing-starttls)
- [Benchmarking](https://github.com/artpar/go-guerrilla/wiki/Profiling#benchmarking)
...
[Daemon.AddProcessor](https://github.com/artpar/go-guerrilla/wiki/Using-as-a-package#registering-a-processor) function to register, then add to your config.
...
See our [change log](https://github.com/artpar/go-guerrilla/wiki/Change-Log) for change and release history
